...
<head>
    ...
    <title data-i18n-doctitle="agencies.title">SAMSAR · Agencies</title>
...
<body>
    ...
    <main>
        <section class="page-head">
            <div class="container">
                <span class="eyebrow reveal" data-i18n="agencies.network">Network</span>
                <h1 class="reveal" data-delay="60"><span data-i18n="agencies.hero.title1">The samsars</span><br /><em data-i18n="agencies.hero.title2">of Morocco.</em></h1>
                <p class="reveal" data-delay="120" data-i18n="agencies.hero.subtitle">14 vetted agencies, hundreds of brokers — every one of them
                    verified by
                    SAMSAR. Find the right partner for your city, your style, your timeline.</p>
                <div class="head-search reveal" data-delay="180">
                    <input type="text" id="agency-search" placeholder="Search agencies by name or city…" data-i18n-placeholder="agencies.search.placeholder" />
                    <button class="btn btn-primary"><span data-i18n="agencies.search.button">Search</span> <span class="arrow">→</span></button>
                </div>
            </div>
        </section>
        ...
        <section class="ag-list">
            <div class="container">
                <div class="ag-tabs reveal">
                    <button class="ag-tab active" data-all="true" data-i18n="agencies.tabs.all">All cities</button>
