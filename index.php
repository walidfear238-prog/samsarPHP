...
<body>
  ...
  <header class="nav" role="banner">
    <div class="container nav-inner">
      ...
      <div class="nav-right">
        ...
        <a href="10-register-choose.php" class="btn btn-primary">
          Join SAMSAR
  ...
  <main>
    ...
    <section class="hero-cinematic">
      ...
      <div class="container hero-content">
        ...
        <a href="10-register-choose.php" class="btn btn-primary hero-cta" data-scroll-hide>Join us</a>
      </div>
    </section>
    ...
    <section class="actions" id="buy">
      <div class="container">
        <div class="actions-header reveal">
          ...
          <p>Whether you're settling in, cashing out, or just exploring — start with a single tap. Every path is
          ...
          <article class="card reveal">
            ...
            <div class="card-body">
              ...
              <div class="card-foot">
                ...
                <a class="card-cta" href="03-property-details.php" data-cursor="hover">View Details <span
                    class="arrow">→</span></a>
              </div>
            </div>
          </article>
      ...
      <div class="container">
        <div class="why-grid">
          <div class="why-intro reveal">
            ...
            <p>The samsar has always been the soul of Moroccan property — the one who knows the door behind the door.
          ...
          <div class="why-stats">
            ...
            <div class="stat reveal" data-delay="100">
              ...
              <h3>Local samsars</h3>
              <p>A network of vetted brokers across Marrakech, Casablanca, Tangier, Fès and the coast.</p>
            </div>
    ...
    <div class="container">
      <div class="footer-grid">
        <div class="footer-brand">
          ...
          <p>The trusted Moroccan broker, reimagined. Properties brokered with transparency, from the Atlas to the
            Atlantic.</p>
        </div>
  ...
  <div class="modal" id="modal" role="dialog" aria-modal="true" aria-labelledby="modal-title" aria-hidden="true">
    ...
    <div class="modal-panel" role="document">
      ...
      <p>Tell us about your property. A SAMSAR broker will reach out within 24 hours with a free valuation.</p>
      <form>
        <div class="field-row">
          <div class="field">
