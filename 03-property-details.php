  ...
  <header class="nav">
    <div class="container nav-inner">
      ...
      <nav class="nav-links"><a href="02-properties.php" class="active">Properties</a><a
          href="04-agencies.php">Agencies</a><a href="06-about.php">About</a><a href="07-contact.php">Contact</a>
      </nav>
        ...
        <aside class="sidebar">
          <div class="agency-card reveal">
            ...
            <form class="agency-form" id="contact-form">
              <div class="field"><label>Full Name</label><input type="text" required value="" placeholder="Your name" />
              </div>
              <div class="field"><label>Message</label><textarea rows="4">I am interested in this property.</textarea>
              </div>
