      ...
      <aside class="filter-side">
        ...
        <div class="filter-panel" id="filter-panel">
          ...
          <div class="fp-group">
            ...
            <div class="check-list">
              <label class="ck"><input type="checkbox" data-city="marrakech" /> <span>Marrakech</span>
                <em>412</em></label>
              <label class="ck"><input type="checkbox" data-city="casablanca" /> <span>Casablanca</span>
                <em>238</em></label>
          ...
          <div class="fp-group">
            ...
            <div class="check-list">
              <label class="ck"><input type="checkbox" data-feature="pool" /> <span>Pool</span></label>
              ...
              <label class="ck"><input type="checkbox" data-feature="sea" /> <span>Sea view</span></label>
        ...
        <div class="results-head reveal">
          ...
          <div class="r-tools">
            ...
            <div class="view-toggle">
              <button class="vt-btn active" data-view="grid" aria-label="Grid view"><svg width="14" height="14"
