    ...
    <main class="dashboard-main">
      ...
      <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:18px;margin-bottom:26px">
        <div class="content-card">
          <div style="font-size:12px;letter-spacing:.12em;color:#666;text-transform:uppercase">Active Listings</div>
          <div id="stat-listings" style="font-family:Fraunces,serif;font-size:34px;margin-top:8px">0</div>
          <a href="my-properties.php" style="font-size:12px;color:#C72C41;margin-top:8px;display:inline-block">Manage
            →</a>
        </div>
        <div class="content-card">
          <div style="font-size:12px;letter-spacing:.12em;color:#666;text-transform:uppercase">Favorites</div>
          <div id="stat-favorites" style="font-family:Fraunces,serif;font-size:34px;margin-top:8px">0</div>
          <a href="favorites.php" style="font-size:12px;color:#C72C41;margin-top:8px;display:inline-block">View →</a>
        </div>
        <div class="content-card">
          <div style="font-size:12px;letter-spacing:.12em;color:#666;text-transform:uppercase">Messages</div>
          <div id="stat-notifications" style="font-family:Fraunces,serif;font-size:34px;margin-top:8px">0</div>
          <a href="messages.php" style="font-size:12px;color:#C72C41;margin-top:8px;display:inline-block">Open →</a>
        </div>
        <div class="content-card">
          <div style="font-size:12px;letter-spacing:.12em;color:#666;text-transform:uppercase">Followers</div>
          <div id="stat-followers" style="font-family:Fraunces,serif;font-size:34px;margin-top:8px">0</div>
          <a href="following.php" style="font-size:12px;color:#C72C41;margin-top:8px;display:inline-block">View →</a>
        </div>
      </div>
        ...
        <section>
          <div class="content-card" style="margin-bottom:18px">
            ...
            <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:12px">
              <a class="btn btn-primary" href="add-property.php" style="text-align:center">+ Add Property</a>
              <a class="btn btn-ghost" href="messages.php" style="text-align:center">Open Messages</a>
              <a class="btn btn-ghost" href="favorites.php" style="text-align:center">View Favorites</a>
            </div>
          </div>

          <div class="content-card">
            <h3 style="font-family:Fraunces,serif;font-size:22px;margin:0 0 14px">Latest Notifications</h3>
            <ul id="notif-list" class="notif-mini-list"></ul>
            <a href="notifications.php"
              style="display:inline-block;margin-top:14px;color:#C72C41;font-size:13px;font-weight:600">View all →</a>
          </div>
        </section>
          ...
          <div class="content-card" style="margin-bottom:18px">
            ...
            <a href="messages.php" class="msg-mini">
              <img src="https://images.unsplash.com/photo-1438761681033-6461ffad8d80?auto=format&fit=crop&w=100&q=80"
                alt="" />
              <div><strong>Élise M.</strong><span>I would like to book a visit for Saturday.</span></div>
            </a>
          </div>
