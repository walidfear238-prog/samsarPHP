...
<head>
  ...
  <link
    ...
    rel="stylesheet" />
  <link rel="stylesheet" href="styles/15-user-messages.css" />
</head>
  ...
  <div class="app">
    <aside class="side">
      ...
      <nav class="side-nav">
        ...
        <a href="15-user-messages.php" class="active"><span class="ico">✉</span> Messages <em class="dot">3</em></a>
      ...
      <div class="msg-layout">
        ...
        <section class="chat" id="chat">
          <header class="chat-head">
            ...
            <div><strong id="chat-name"></strong><span id="chat-sub"></span></div>
            <div class="chat-tools"><button title="Call">☎</button><button title="Video">⎚</button><button
                title="More">⋯</button></div>
          </header>
          <div class="chat-body" id="chat-body"></div>
          <form class="chat-input" id="chat-form">
            <button type="button" class="attach" title="Attach">+</button>
            <input type="text" id="msg-input" placeholder="Write a message…" autocomplete="off" />
            <button type="submit" class="send">Send <span class="arrow">→</span></button>
          </form>
        </section>
      </div>
    </main>
  </div>
  <script src="scripts/15-user-messages.js"></script>
</body>
