    ...
    <header class="nav">
        <div class="container nav-inner">
            ...
            <nav class="nav-links"><a href="02-properties.php">Properties</a><a href="04-agencies.php">Agencies</a><a
                    href="06-about.php" class="active">About</a><a href="07-contact.php">Contact</a>
    ...
    <main>
        <section class="hero">
            <div class="container">
                ...
                <p class="reveal" data-delay="120">In Morocco, the <em>samsar</em> has always been the soul of property
                    — the
        ...
        <section class="story">
            <div class="container story-grid">
                ...
                <div class="story-text">
                    ...
                    <p class="reveal" data-delay="120">SAMSAR was founded in 2026 by three Moroccan technologists who
                        had each,
                    ...
                    <p class="reveal" data-delay="180">We started as a quiet experiment: what if every listing was
                        verified before
            ...
            <div class="container">
                ...
                <div class="val-grid">
                    <div class="val reveal"><span class="num">01</span>
                        ...
                        <p>Every title deed is cross-checked with the Conservation Foncière. Every photograph is matched
                            to GPS
                            data. No exceptions.</p>
                    </div>
                    <div class="val reveal" data-delay="100"><span class="num">02</span>
                        <h3>Transparent commission</h3>
                        <p>A flat 2.5% commission, itemised in writing, disclosed before any visit. No referral
                            kickbacks. No
                            surprise fees at closing.</p>
                    </div>
                    <div class="val reveal" data-delay="200"><span class="num">03</span>
                        <h3>Bilingual contracts</h3>
                        <p>Arabic, French, English. Drafted by a Moroccan notary you choose — never one we refer for a
                            fee.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                ...
                <div class="team-grid">
                    <div class="member reveal"><img
                            ...
                            alt="Salma El Idrissi" /><strong>Salma El Idrissi</strong><span>Co-founder · Product</span>
                    </div>
                    <div class="member reveal" data-delay="80"><img
                            src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=500&q=80"
                            alt="Yassine Berrada" /><strong>Yassine Berrada</strong><span>Co-founder ·
                    ...
                    <div class="member reveal" data-delay="160"><img
                            ...
                            alt="Imane Cherkaoui" /><strong>Imane Cherkaoui</strong><span>Co-founder · Brokerage</span>
                    </div>
